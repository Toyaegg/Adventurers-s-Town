...
const BUILDING_FEATURE_FINISH_DUNGEON := "404"
const BUILDING_FEATURE_FINISH_SHOPPING := "405"
const BUILDING_FEATURE_FINISH_SELLING := "406"
const BUILDING_FEATURE_FINISH_TREAT := "407"
const BUILDING_FEATURE_FINISH_LIFT := "408"
const BUILDING_FEATURE_FINISH_BLESSING := "409"
const BUILDING_FEATURE_FINISH_REST := "410"
const BUILDING_FEATURE_FINISH_TRAINING := "411"
